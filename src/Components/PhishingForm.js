...
const PhishingForm = () => {
    ...
    const [formData, setFormData] = useState({
      ...
      const validate = (inputName = '') => {
        ...
        if (formData.target.length < 3) {
          error.target = 'target should be at least 3 characters';
        }
        if (formData.urls.length < 10) {
          error.urls = 'URLs content should be at least 10 characters';
        }
            ...
            <div className="row">
                ...
                <div className="col-lg-4 col-md-6">
                    ...
                    <label className="form-label" htmlFor="target">
                        <span className="input-title">Target of Phishing Campaign</span>
                        <input className={`form-input ${(errors.target)? "error" : ((formData.target != '')?'valid':'')}`} type="text" name="target" id="target" required
                ...
                <div className="col-lg-6">
                    ...
                    <label className="form-label" htmlFor="logs">
                        <span className="input-title">Additional Evidence or Logs</span>
